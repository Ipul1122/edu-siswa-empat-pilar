...
<div class="card" style="max-width: 600px; margin: 0 auto; width: 100%; box-shadow: var(--shadow-md); border-radius: var(--border-radius-lg);">
    <div class="card-body" style="padding: 40px; text-align: center; display: flex; flex-direction: column; gap: 24px;">
        ...
        <div style="color: var(--color-gray-600); line-height: 1.6; font-size: 1rem; text-align: left;">
            {!! $quiz->description ? (str_contains($quiz->description, '<') ? $quiz->description : nl2br(e($quiz->description))) : 'Uji pemahaman nyata Anda mengenai pilar kebangsaan ini melalui beberapa butir soal pilihan ganda.' !!}
        </div>
