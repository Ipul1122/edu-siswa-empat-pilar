...
<div class="page-header">
    <div class="page-title">
        <h1>Edit Materi</h1>
        <p>Perbarui artikel belajar mengenai kewarganegaraan Empat Pilar Kebangsaan menggunakan editor teks kaya.</p>
    </div>
...
<div class="card" style="max-width: 900px; margin: 0 auto; width: 100%;">
    <div class="card-body">
        <form action="{{ route('admin.materials.update', $material) }}" method="POST" id="material-form">
            @csrf
            @method('PUT')
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 16px;">
                ...
                <div class="form-group">
                    ...
                    <select name="pillar" id="pillar" class="form-control @error('pillar') is-invalid @enderror" required>
                        ...
                        <option value="twk_kedinasan" {{ old('pillar', $material->pillar) === 'twk_kedinasan' ? 'selected' : '' }}>Simulasi TWK Kedinasan</option>
                    </select>
                    @error('pillar')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-group">
                ...
                <div id="editor">{!! old('content', $material->content) !!}</div>
