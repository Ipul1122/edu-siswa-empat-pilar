...
<div class="page-header">
    <div class="page-title">
        ...
        <p>Tulis artikel belajar mengenai kewarganegaraan Empat Pilar Kebangsaan.</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.materials.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" style="height: 350px;" placeholder="Tulis konten pembelajaran di sini..." required>{{ old('content') }}</textarea>
                @error('content')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
