...
<div class="page-header">
    <div class="page-title">
        ...
        <p>Kuis: <strong>{{ $quiz->title }}</strong> | Kategori: <span class="badge {{ $quiz->pillar }}">{{ $quiz->formatted_pillar }}</span></p>
    </div>
...
<div class="card" style="max-width: 850px; margin: 0 auto; width: 100%;">
    <div class="card-body">
        <form action="{{ route('admin.questions.store', $quiz) }}" method="POST" id="question-form">
            @csrf
            ...
            <div class="form-group" style="margin-bottom: 24px;">
                ...
                <div id="editor_question" style="min-height: 150px;">{!! old('question_text') !!}</div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 20px; margin-top: 28px;">
                ...
                <div class="form-group">
                    ...
                    <div id="editor_explanation" style="min-height: 120px;">{!! old('explanation') !!}</div>
                    <input type="hidden" name="explanation" id="explanation" value="{{ old('explanation') }}">
